...
@{
    ...
    Description       = 'Enables user interaction with the API for the CyberArk DPA platform'
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ProjectUri   = 'https://github.com/pspete/IdentityCommand.DPA/'

            # A URL to an icon representing this module.
            IconUri      = 'https://raw.githubusercontent.com/pspete/IdentityCommand.DPA/main/docs/media/images/IdentityCommand.DPA-Logo.png'

            # ReleaseNotes of this module
            ReleaseNotes = 'https://github.com/pspete/IdentityCommand.DPA/blob/main/CHANGELOG.md'
