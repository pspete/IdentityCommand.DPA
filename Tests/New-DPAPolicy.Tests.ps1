    ...
    InModuleScope $(Split-Path (Split-Path (Split-Path -Parent $PSCommandPath) -Parent) -Leaf ) {
        ...
        Context 'Input' {
            BeforeEach {
                ...
                New-DPAPolicy -policyName SomePolicy -status Enabled -description 'Some Description' -providersData $Providers -userAccessRules $AccessRules -startDate (Get-Date -Year 1925 -Month 10 -Day 8) -EndDate (Get-Date -Year 2023 -Month 1 -Day 22)
            }
            It 'sends request' {
